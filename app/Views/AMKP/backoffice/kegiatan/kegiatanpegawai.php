...
if (isset($dtKegiatan)) {
    ...
    $unitkerja = $dtKegiatan[0]["unitkerja"];
        ...
        <div class="row">
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#" onclick="onClickPreviousButton('<?= $unitkerja_id; ?>', '<?= $periode; ?>');"><i class="fas fa-arrow-circle-left"></i> Kembali</a></li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                ...
                <div class="card card-outline card-primary">
                    <div class="card-body pb-0">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="unitkerja" name="unitkerja" value="<?= $unitkerja; ?>" readonly>
                            </div>
                        </div>
                    </div>
                </div>
