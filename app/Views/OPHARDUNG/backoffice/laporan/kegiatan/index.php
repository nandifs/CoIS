            ...
            <div class="col-md-12">
                <div class="card card-outline card-primary mt-2">
                    <div class="card-body pb-0">
                        <?= form_open_multipart('/laporan_ophardung_kegiatan', ['id' => 'frm-refresh', 'class' => 'form-horizontal']); ?>
                        <?= csrf_field(); ?>
                                    ...
                                    <div class="panel-body">
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                <button type="submit" class="dropdown-item" name="cmdaksi" value="export_laporan_kegiatan_ophar_to_xls">Ekspor Ke Excel</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
