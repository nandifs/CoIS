            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="/presensi_tenagakerja"><i class="fas fa-arrow-circle-left"></i> Kembali</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-6">
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-footer">
                            <button type="button" class="btn btn-default float-right" onclick="location.href='/presensi_tenagakerja';">Kembali</button>
                        </div>
                        <!-- /.card-footer -->
                    </div>
                    <!-- /.card -->
