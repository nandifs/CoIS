                                                    ...
                                                    <tr>
                                                     ...
                                                     <a data-toggle="tooltip" data-placement="top" title="Tamu Keluar/Pulang">
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php if ($dcUser['oid'] != 5) : ?>
                                                                <a href="<?php echo base_url('bukutamu/edit/' . $rowId); ?>" data-toggle="tooltip" data-placement="top" title="Edit">
                                                                    <button type="button" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></button>
                                                                </a>
                                                                <a href="<?php echo base_url('bukutamu/delete/' . $rowId); ?>" data-toggle="tooltip" data-placement="top" title="Hapus" onclick="return confirm('Hapus data <?= $title; ?> : <?php echo $row['nama_tamu']; ?> ?')" style="display:none">
