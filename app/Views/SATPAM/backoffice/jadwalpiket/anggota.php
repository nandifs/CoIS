                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <div class="btn-group">
                                            ...
                                            <?php if ($oto_id == 0 || $oto_id == 1 || $oto_id == 2 || $oto_id == 3) : ?>
                                    ...
                                    <table id="tbljwlpiket" class="table table-bordered" style="table-layout: fixed;">
                                        <thead style="padding:0">
                                            <tr style="padding:0">
                                                ...
                                                <th rowspan="3" style="padding:0; vertical-align : middle; text-align: center; font-weight: normal;">Petugas</th>
                                                <th rowspan="3" style="padding:0; vertical-align : middle; text-align: center; font-weight: normal;">Regu</th>
                                                <th rowspan="3" style="padding:0; vertical-align : middle; text-align: center; font-weight: normal;">Jabatan</th>
                                                <th colspan="31" style="padding:0; text-align: center;">BULAN <?= $blnTahun; ?></th>
                                            </tr>
                                            <tr>
                                                <?php
                                                $jmlhari = ambil_jumlah_hari(7, 2020);
                                                $fdate = date('Y-m-01');
                                            ...
                                            if (isset($dtRegu)) {
                                                ...
                                                foreach ($dtRegu as $row) {
                                                    ...
                                                    if ($namaRegu != "Non Shift") {
                                                        ...
                                                        echo "<td style='padding:0; padding-left:5px;'>$row[petugas]</td>";
                                                        echo "<td style='padding:0; padding-left:5px;'>$row[regu]</td>";
                                                        echo "<td style='padding:0; padding-left:5px;'>$row[jabatan]</td>";
                                                        for ($ctr = 1; $ctr <= $jmlhari; $ctr++) {
                                                            $shift = $regu[$row['regu_id']];
                                                            $sfc = $shift[$ctr - 1];
                                                            if ($sfc == "L") {
