                ...
                <div class="col-md-12">
                    <div class="card card-outline card-primary mt-2">
                        <div class="card-body pb-0">
                            <?= form_open_multipart('/laporan_presensitenagakerja', ['id' => 'frm-refresh', 'class' => 'form-horizontal']); ?>
                            <?= csrf_field(); ?>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="laporan_presensi_tk_detail/<?= $rowId; ?>" data-toggle="tooltip" data-placement="top" title="Info">
