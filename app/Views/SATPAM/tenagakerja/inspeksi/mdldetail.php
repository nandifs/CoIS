<div class="modal fade" id="MdlDetailInspeksi">
                ...
                <div class="card card-success card-outline">
                    <div class="card-body box-profile form-horizontal">
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <div class="profile-user-img img-foto img-rounded img-fluid img-responsive">
                                    <img class="stretch" id="img_foto" src="<?php echo base_url(); ?>/uploads/noimage.jpg" alt="Foto Inspeksi">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="kondisi" name="kondisi" placeholder="Lokasi Inspeksi" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
