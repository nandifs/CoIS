    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-success">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <?= form_open_multipart('/satpam_bukutamu_update', ['class' => 'form-horizontal', 'id' => 'form-bukutamu']); ?>
                <?= csrf_field(); ?>
                <?php
                $tgl = waktu();
                ...
                $folderMK = addZeroSpaces($dtTamu['mitrakerja_id'], "mk", 5);
                $blnthn = ambil_angka_bulan_tahun($dtTamu['jam_masuk']);
                $pathFoto = "/uploads/$appName/$folderMK/$blnthn/";
                ?>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="hidden" name="data_id" value="<?= $dtTamu['id']; ?>">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="img-foto"><img class="img-foto" src="<?= base_url($pathFoto . '/bukutamu/id') . '/fid' . $dtTamu['file_foto_dan_ttd']; ?>.jpg" /></div>
                            </div>
                            <div class="form-group">
                                <label>Foto Tamu:</label>
                                <div class="img-foto"><img class="img-foto" src="<?= base_url($pathFoto . '/bukutamu/foto') . '/ftm' . $dtTamu['file_foto_dan_ttd']; ?>.jpg" /></div>
                            </div>
                            <div class="form-group">
                                <label>Tanda Tangan:</label>
                                <div class="sign-area"><img src="<?= base_url($pathFoto . '/bukutamu/ttd') . '/ttd' . $dtTamu['file_foto_dan_ttd']; ?>.png" /></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-footer">
                    <button type="button" class="btn btn-default" onclick="location.href='/satpam_bukutamu';">Batal</button>
