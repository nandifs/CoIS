    ...
    if (isset($dtTenagakerja)) {
        ...
        if ($dtTenagakerja->pendidikan_terakhir != "") {
            $pendidikan = $dtTenagakerja->pendidikan_terakhir . "/" . $dtTenagakerja->program_studi;
        } else {
            $pendidikan = "";
        }
                                    ...
                                    <div class="card card-outline card-warning">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="no_pks" placeholder="Nomor PKS dengan pengguna jasa" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="input1" class="col-sm-3 col-form-label">No. PKWT</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="no_pkwt" placeholder="No. PKWT" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="input1" class="col-sm-3 col-form-label">Tanggal Kontrak Awal</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="tgl_kontrak_awal" placeholder="Tanggal Kontrak Awal" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="input1" class="col-sm-3 col-form-label">Tanggal Kontrak Akhir</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="tgl_kontrak_akhir" placeholder="Tanggal Kontrak Akhir" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card card-outline card-warning">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" class="form-control" name="payroll_bank" placeholder="NAMA BANK PENYETORAN PAYROLL" readonly>
                                                </div>
                                                <label for="input1" class="col-sm-2 col-form-label text-right">NOMOR REKENING</label>
                                                <div class="col-sm-2">
                                                    <input type="text" class="form-control" name="payroll_norekening" placeholder="NO REKENING BANK" readonly>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                    ...
                                    <div class="card card-outline card-warning">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" class="form-control" name="no_bpjs_kt" placeholder="NOMOR KEPESERTAAN BPJS KETENAGAKERJAAN" readonly>
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" class="form-control" name="no_bpjs_ks" placeholder="NOMOR KEPESERTAAN BPJS KESEHATAN" readonly>
                                                </div>
                                                <label for="input1" class="col-sm-1 col-form-label text-right">JUMLAH</label>
                                                <div class="col-sm-2">
                                                    <input type="text" class="form-control" name="persentase_bpjs_kt" readonly>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-3">
                                                    <input type="text" class="form-control" name="bank_dplk" placeholder="NAMA BANK PENYETORAN DPLK" readonly>
                                                </div>
                                                <label for="input1" class="col-sm-1 col-form-label text-right" style="padding-left: 0px ;">NO. REKENING</label>
                                                <div class="col-sm-2">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="no_npwp" placeholder="NOMOR NPWP" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
