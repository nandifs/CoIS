                                ...
                                <div class="col-sm-5">
                                    <div class="panel panel-default float-right">
                                        <div class="panel-body">
                                            <button type="submit" class="btn btn-primary"><i class="fa fa-plus"></i> Data Tenagakerja</button>
                                            <a href="tenagakerja/cetak" class="btn btn-primary" style="display:none"><i class="fa fa-print"></i> Cetak Daftar Tenagakerja</a>
                                            <button type="button" class="btn btn-warning <?= ($dcUser["oid"] != 1) ? "d-none" : ""; ?>" data-toggle="modal" data-target="#modal-import">
                                                <i class="fa fa-file-import"></i> Impor Data Tenagakerja
                                            </button>
                                        </div>
                                    </div>
                                </div>
