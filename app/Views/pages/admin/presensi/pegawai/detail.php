                    ...
                    <div class="card card-outline card-primary mt-2">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="penempatan" class="form-control" value="<?= $dtPegawai['penempatan']; ?>" readonly>
                            </div>
                            <?php  ?>
                        ...
                        <div class="card-footer">
                            <button type="button" class="btn btn-default float-right" onclick="onClickPreviousButton('<?= $unitkerja_id; ?>', '<?= $periode; ?>', '<?= $actionkey; ?>')">Kembali</button>
                        </div>
                        <!-- /.card-footer -->
                    </div>
                    <!-- /.card -->
