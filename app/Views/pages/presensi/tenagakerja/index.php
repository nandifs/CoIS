                    ...
                    <div class="card card-outline card-success">
                        <div class="card-body">
                            ...
                            if (is_null($dtPresensiAktif)) {
                                echo "<a href='presensi_tk_add' class='btn btn-primary mt-1'><i class='fas fa-calendar-check'></i> Isi Presensi</a>";
                            } else {
                                echo "<a href='presensi_tk_out/" . $dtPresensiAktif['id'] . "' class='btn btn-danger mt-1'><i class='fas fa-door-closed'></i> Abensi Pulang</a>";

                                echo "<a href='/' class='btn btn-primary mt-1 float-right'><i class='fas fa-arrow-left'></i> Kembali</a>";
                            }
                            ?>

                            <a href="presensi/cetak_tenagakerja" class="btn btn-primary mt-1 d-none"><i class="fa fa-print"></i> Cetak Presensi</a>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    <td><?= $no; ?>.</td>
                                                    <td>
                                                        <a href="presensi_tk_detail/<?= $rowId; ?>" data-toggle="tooltip" data-placement="top" title="Detail">
