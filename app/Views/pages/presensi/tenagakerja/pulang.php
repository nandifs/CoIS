            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card card-primary card-outline">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <?= form_open_multipart("/presensi_tk_saveout", ['id' => 'form-presensi', 'class' => 'form-horizontal']); ?>
                        <?= csrf_field(); ?>
                        <?php
                        $tgl = waktu();
                        $tglmasuk = date("Y-m-d");
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="img-foto align-items-center justify-content-center">
                                    <?php
                                    $imgFoto = base_url($pathFotoPresensiF1) . '/' . $dtPresensi['foto_1'];
                                    $imgFoto = checkUploadImgIfExist($imgFoto);
                                    ?>
                                    <img class="img-foto" src="<?= $imgFoto; ?>" />
                                </div>
                            </div>
                            <div class="form-group row">
