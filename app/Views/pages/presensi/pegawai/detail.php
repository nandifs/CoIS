                    ...
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group  <?= $setDisplay; ?>">
                                ...
                                <div style="text-align: center;">
                                    <?php if ($setDisplay != 'd-none') {
                                        $imgFoto1 = $pathFotoPresensi . '/f1/' . $dtPresensi['foto_1'];
                                        $imgFoto1 = checkUploadImgIfExist($imgFoto1);
                                    ?>
                                        <img class="form-control img-foto" src="<?= base_url($imgFoto1); ?>" />
                                    <?php } ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group <?= $setDisplay; ?>">
                                ...
                                <div style="text-align: center;">
                                    <?php if ($setDisplay != 'd-none') {
                                        $imgFoto2 = $pathFotoPresensi . '/f2/' . $dtPresensi['foto_2'];
                                        $imgFoto2 = checkUploadImgIfExist($imgFoto2); ?>
                                        <img class="form-control img-foto" src="<?= base_url($imgFoto2); ?>" />
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="form-group row <?= $setDisplay; ?>">
                        ...
                        <div class="card-footer">
                            <button type="button" class="btn btn-default float-right" onclick="location.href='/presensi_data';">Kembali</button>
                        </div>
                        <!-- /.card-footer -->
                    </div>
                    <!-- /.card -->
