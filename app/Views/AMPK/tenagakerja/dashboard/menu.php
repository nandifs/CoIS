                                ...
                                <div class="panel-body text-center">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6 col-md-6">
                                            <?php if (is_null($dtPresensiAktif)) { ?>
                                                <a href="/ophardung_kegiatan_add" class="btn btn-secondary btn-lg" role="button"><i class="fas fa-user-shield"></i> <br /><small>Kegiatan</small></a>
                                                <a href="/ophardung_petugas_inventori" class="btn btn-secondary btn-lg" role="button"><i class="fas fa-book"></i> <br />Alat/Matrial</a>
                                            <?php } else { ?>
                                                <a href="/ophardung_kegiatan_add" class="btn btn-info btn-lg" role="button"><i class="fas fa-user-shield"></i> <br /><small>Kegiatan</small></a>
                                                <a href="/ophardung_petugas_inventori" class="btn btn-info btn-lg" role="button"><i class="fas fa-book"></i> <br />Alat/Matrial</a>
                                            <?php } ?>
                                        </div>
